...
export default function ContractForm({ onNewClick }: ContractFormProps) {
  return (
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <input
            ...
            className="h-10 w-64 rounded-xl border border-slate-200 bg-white pl-4 pr-10 text-sm outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm"
          />
