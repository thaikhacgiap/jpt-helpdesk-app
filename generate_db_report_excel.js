...
async function createReport() {
  ...
  const tablesList = [
    ...
    { stt: 16, name: 'projects', module: 'Quản lý Dự án v4.0', storage: 'Supabase DB', status: 'Đã tích hợp DB', records: 5, desc: 'Kế hoạch dự án, giai đoạn (Phase), task con, Gantt Chart, Milestone, Nhật ký', files: 'projects_migration.sql, project-operations.ts, app/projects/' },
