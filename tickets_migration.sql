...
ALTER TABLE tickets ADD COLUMN IF NOT EXISTS request_code    VARCHAR(100);
ALTER TABLE tickets ADD COLUMN IF NOT EXISTS request_time     TIMESTAMP WITH TIME ZONE;
