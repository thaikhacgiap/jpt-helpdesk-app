...
import { UsersRound, FileText, Target } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const checkAndRunAutoSync = async (isInitial = false) => {
      ...
      try {
        const payload: any = {
          sheetUrl,
          sheetName: localStorage.getItem("jpt_customer_sheet_name") || "Account",
          userAccessToken,
          userRefreshToken,
          userClientId,
          userClientSecret,
  ...
  return (
    <MainLayout>
      <div className="flex flex-col h-[calc(100vh-28px)] overflow-hidden">
        ...
        {/* Table Container - Flex 1 to fit remaining viewport exactly */}
